...
function data_completa ($data_contrato){
    setlocale(LC_TIME, 'portuguese'); 
    date_default_timezone_set('America/Sao_Paulo');
    $dataArr = explode("/",$data_contrato);
    $data_format = $dataArr[2] . '-' . $dataArr[1] . '-' . $dataArr[0];
    $date = date($data_format);
...
<body>
    ...
    <div class="corpo-pedido">
        <div class="row">
            <table>
                <tr>
                    <th class="titulo-fatura"><span class="logo-fatura"><img
                                src="./images/logo-contrato-verde.png"></span>
                    </th>
        ...
        <div>
            ...
            <ul>
                <li>
                    a) SÓCIO OSTENSIVO - Subscrevem e integralizam 99,99%, do capital social da SCP no valor de R$
                    9.999,00
                    (Nove mil novecentos e noventa e nove reais) em moeda corrente do País;
                </li>
                <li>b) SÓCIO PARTICIPANTE - Subscrevem e integralizam 0,01%, do capital social da SCP no valor de R$
                    1,00
            ...
            <p><span class="titulo-clausula">CLÁUSULA SÉTIMA - DO INTUITO PERSONAE</span><br />
                ...
                condições.
                <br /><br />
                <b><u>Parágrafo Primeiro</u></b> - O sócio que desejar transferir suas quotas deverá notificar o sócio
                remanescente,
                ...
                <br /><br />
                <b><u>Parágrafo Segundo</u></b> - Igualmente, a alteração do quadro societário e a transferência de
                quotas que
            ...
            <p><span class="titulo-clausula">CLÁUSULA NONA - DAS OBRIGAÇÕES DOS SÓCIOS PARTICIPANTES</span><br />
                ...
                <b><u>Parágrafo único</u></b> - O local, carga horária e a forma da prestação do serviço médico prestado
                pelo SÓCIO
            ...
            <p><span class="titulo-clausula">CLÁUSULA DÉCIMA - DAS OBRIGAÇÕES DOS SÓCIO OSTENSIVO</span><br />
                ...
                demais cláusulas e condições do presente contrato:<br />

                1 - Elaborar e coordenar as escalas de plantão médico;<br />
            ...
            <p><span class="titulo-clausula">CLÁUSULA DÉCIMA SEGUNDA - DA RESCISÃO</span><br />
                O presente contrato só poderá ser rescindido nas seguintes hipóteses:<br />
                1 - Por mútuo acordo;<br />
                2 - Ao final do prazo de vigência ora estipulado;<br />
                3 - Em decorrência da prática de infração legal ou contratual;<br />
                4 - Em decorrência da falta de repasse dos lucros e demais encargos.<br /><br />

                <b><u>Parágrafo Único</u></b> - Para efeitos de rescisão contratual, o presente contrato sempre será
                interpretado,
            ...
            <p><span class="titulo-clausula">CLÁUSULA DÉCIMA QUARTA - DAS DISPOSIÇÕES GERAIS</span><br /><br />
                <b><u>Parágrafo Primeiro</u></b> - o ano social coincidirá com o ano civil, devendo ao dia 31 de
                ...
                prejuízos distribuídos ou suportados mensalmente.<br /><br />
                <b><u>Parágrafo Segundo</u></b> - O falecimento ou incapacidade de qualquer um dos sócios não dissolverá
                a sociedade,
                ...
                credenciados pelos demais.<br /><br />
                <b><u>Parágrafo Terceiro</u></b> - os casos omissos no presente contrato serão regulados pela Lei das
                Sociedades
                Anônimas, ou outra que lhe seja mais pertinente.<br /><br />

                As partes elegem o foro da cidade de Trindade-GO, para dirimirem qualquer dúvida do presente
                contrato.<br /><br />
                ...
                <br /><br />
                <p style="text-align:right;">Trindade, <?php echo data_completa($data_contrato); ?></p>
                <br /><br /><br /><br />
                <p style="text-align:center;">
                    ______________________________________________________________________<br />
                                            <b>RPC E Associados S/S LTDA</b><br />
                                            SÓCIO OSTENSIVO
                </p>
                <br /><br />
                <p style="text-align:center;">
                    ______________________________________________________________________<br />
                                            <b><?php echo $perfil->nome_completo; ?></b><br />
                                            SÓCIO PARTICIPANTE
                </p>
...
$dompdf->render();
ob_end_clean();
$namefile = "$inscricao-$perfil->nome_completo.pdf";
